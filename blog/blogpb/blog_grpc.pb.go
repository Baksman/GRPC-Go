...
type BlogServiceClient interface {
	...
	AllBlogs(ctx context.Context, in *BlogListRequest, opts ...grpc.CallOption) (*BlogListResponse, error)
}
...
func (c *blogServiceClient) AllBlogs(ctx context.Context, in *BlogListRequest, opts ...grpc.CallOption) (*BlogListResponse, error) {
	out := new(BlogListResponse)
	err := c.cc.Invoke(ctx, "/blog.BlogService/AllBlogs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BlogServiceServer interface {
	...
	AllBlogs(context.Context, *BlogListRequest) (*BlogListResponse, error)
}
...
func (UnimplementedBlogServiceServer) AllBlogs(context.Context, *BlogListRequest) (*BlogListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AllBlogs not implemented")
}
...
func _BlogService_AllBlogs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BlogListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BlogServiceServer).AllBlogs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blog.BlogService/AllBlogs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlogServiceServer).AllBlogs(ctx, req.(*BlogListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BlogService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AllBlogs",
			Handler:    _BlogService_AllBlogs_Handler,
		},
	},
